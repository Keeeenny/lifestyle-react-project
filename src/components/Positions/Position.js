  ...
  return (
    <main className="position">
      ...
      <ol className="steps">
        <li>1{")"} Take a seat</li>
        <p>
          Sit comfortably, remembering to keep your back straight. You can sit
          on a chair or if you prefer on the floor assuming the classic lotus
          position.
        </p>
        ...
        <p>
          If you're a beginner, is better to start with a short time, such as 5
          or 10 minutes. The ideal would then be to reach 15 or 20 minutes of
          session.
        </p>
        <li>3{")"} Focus on the breath</li>
        <p>
          Focus on your breath as it goes in and as it goes out. Inevitably,
